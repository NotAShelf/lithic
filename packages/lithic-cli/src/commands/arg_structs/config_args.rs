...
pub enum ConfigSubCommand {
   ...
   /// You can set multiple values at the same time: Lithic config del -mzB
   Del(DelArgs),
...
pub struct CommonArgs {
   /// Default mod directory Lithic will manage
   ///
   ...
   ///
   /// Directory structure:
   ///     ~/.config/lithic/modpacks/{mypacks, packs, installed}
   #[arg(short = 'M', long)]
   ...
   /// Pin a specific game version. Lithic will only download mods that specifically state they support this version.
   ///
   /// Default: None
   ...
   ///
   /// Before Lithic updates any file, the old version will be copied to the --backup-mods-dir.
   ///
   /// Default: false
   ///
   #[arg(short, long)]
   ...
   /// Use with --with-mod to pin a specific mod version. Use `Lithic info modid --versions` to see all available versions.
   ///
   ///Note: Lithic does not validate the version being set here.
   #[arg(short = 'P', long, requires = "with_mod", value_name = "VERSION")]
   pub pin_version: Option<String>,

   /// If for some reason your lithic config gets messed and you have modpacks installed, but not enabled, use this command to add it back to the disabled list so you can enable it again.
   #[arg(long, value_name = "MPK_ID")]
   pub modpack_disabled: Option<String>,

   /// If your lithic config gets messed up and you had modpack(s) enabled, use this to readd it to the config. This will allow you to properly manage the modpack again.
   #[arg(long, value_name = "MPK_ID")]
   pub modpack_enabled: Option<String>,

   /// Do you want lithic to check for updates automatically?
...
pub struct DelArgs {
   ...
   /// The highest game version Lithic will use to download mods
   #[arg(short, long)]
   ...
   /// Specify a pinned mod. Use `Lithic config list` to see all set mods and their IDs
   #[arg(short = 'P', long, value_name = "MOD_ID")]
   pub pinned_mod: Option<ModID>,

   /// Remove a modpack id from the modpacks.disabled list. ONLY do this if lithic and the config are out of sync and your modpack doesn't exist anymore.
   #[arg(long, value_name = "MPK_ID")]
   pub modpack_disabled: Option<String>,

   /// Remove a modpack id from the modpacks.enabled list. ONLY do this if lithic and the config are out of sync and your modpack doesn't exist anymore.
   #[arg(long, value_name = "MPK_ID")]
   pub modpack_enabled: Option<String>,
